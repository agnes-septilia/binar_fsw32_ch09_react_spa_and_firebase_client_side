...
//import css
import '../../Styles/GamePages/gamelist.css';
...
function GameListPage() {
    ...
    return (
        <div className='gamelist-body'>
            <Container className='my-5 gamelist-container'>
                {gameslist.data.map(function (data) {
                    return (
                        <Card
                            style={{
                                
                            }} className='gamelist-cardClass'
                        >
                            <img
                                alt="Sample"
                                src={data.game_image_url}
                            />    
                            <CardBody className='gamelist-card text-dark'>
                                <CardTitle class="gamelist-judul text-bold">
                                    {data.game_name}
                                </CardTitle>
                                <CardText className="gamelist-text text-dark">
